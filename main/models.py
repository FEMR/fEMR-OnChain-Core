...
suffix_choices = (("j", "Jr."), ("s", "Sr."), ("1", "I"), ("2", "II"), ("3", "III"))
...
class Organization(models.Model):
    ...
    main_contact = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name="organization_main_contact",
    )
...
class Campaign(models.Model):
    ...
    encounter_close = models.PositiveIntegerField(default=30)
    country = models.CharField(max_length=30)
    timezone = models.CharField(max_length=100, choices=COMMON_TIMEZONES_CHOICES)
    ...
    main_contact = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name="campaign_main_contact",
    )
...
class Patient(models.Model):
    ...
    ethnicity = models.ForeignKey(
        Ethnicity,
        on_delete=models.CASCADE,
        default=get_nondisclosed_ethnicity,
        null=True,
        blank=True,
    )
...
class HistoryOfPresentIllness(models.Model):
    chief_complaint = models.ForeignKey(
        ChiefComplaint, on_delete=models.CASCADE, editable=False
    )
    encounter = models.ForeignKey(
        PatientEncounter, on_delete=models.CASCADE, editable=False
    )
...
class Vitals(models.Model):
    ...
    def unit_aware_temperature(self, unit):
        return (
            ...
            if unit == "m"
            else (float(self.body_temperature) * 1.8) + 32
        )
