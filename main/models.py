...
class Allergy(models.Model):
    """
    Represents a patient allergy to a specific medication.
    This should not be used for allergies to non-medications.
    If this is needed, another subclass of `models.Model` should be created.
    """
    ...
    def __str__(self):
        ...
        :return: `Allergy.medication.name` as a string.
        """
...
class Immunization(models.Model):
    ...
    def __str__(self):
        ...
        :return: Immunization.name as a string.
        """
...
class Problem(models.Model):
    """
    Used to report new patients complaints.
    """
    name = models.CharField(max_length=30)
...
class Procedure(models.Model):
    """
    Used to report past medical procedures.
    """
    name = models.CharField(max_length=30)
    ...
    def __str__(self):
        ...
        :return: `Procedure.name` as a string.
        """
        return str(self.name)
...
class HealthConcern(models.Model):
    """
    Used to report formal factors for health concerns.
    """
    name = models.CharField(max_length=30)
    ...
    def __str__(self):
        ...
        :return: The name of the `HealthConcern` as a string.
        """
        return str(self.name)
...
class Test(models.Model):
    """
    Used by the LabTest object to track a single specific test procedure.
    """
    name = models.CharField(max_length=30)
...
class LabTest(models.Model):
    """
    Manages an individual's lab test results.
    """
    ...
    def __str__(self):
        ...
        :return: The name of the associated `Test`.
        """
...
class Medication(models.Model):
    """
    Represents a variety of medications a patient may take.
    """
