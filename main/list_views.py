...
from .models import Allergy, Immunization, PatientEncounter, Procedure, Medication, LabTest, Test, Patient, HealthConcern, Campaign


def allergy_list_view(request):
    """
    Produces an administrative list of Allergies that patients may exhibit.
...
def immunization_list_view(request):
    """
    Displays an administrative list of Immunizations that a patient may have had.
...
def problem_list_view(request):
    """
    Displays an administrative list of recorded health problems.
...
def procedure_list_view(request):
    """
    Administrative list of recorded medical procedures.
...
def medication_list_view(request):
    """
    Administrative list of medications reported by patients.
...
def lab_test_list_view(request):
    """
    Displays an administrative list of lab test results reported by patients.
...
def test_list_view(request):
    """
    Displays an administrative list of tests reported by patients.
...
def health_concern_list_view(request):
    """
    Displays an administrative list of recorded health concerns.
