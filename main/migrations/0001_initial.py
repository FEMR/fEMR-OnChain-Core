    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        related_name="campaign_admins", to=settings.AUTH_USER_MODEL
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "mode_option",
                    models.CharField(
                        choices=[("1", "New"), ("2", "Update")], max_length=10
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        blank=True,
                        default=main.models.get_nondisclosed_ethnicity,
                        null=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "body_height_secondary",
                    models.FloatField(
                        blank=True,
                        null=True,
                        validators=[
                            main.models.ModifiedMaxValueValidator(100),
                            django.core.validators.MinValueValidator(0),
                        ],
                    ),
                ),
                ...
                (
                    "chief_complaint",
                    models.ManyToManyField(blank=True, to="main.ChiefComplaint"),
                ),
                (
                    "patient",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "medication",
                    models.ManyToManyField(blank=True, to="main.Medication"),
                ),
                (
                    "prescriber",
                    models.ForeignKey(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                blank=True,
                default=main.models.get_nondisclosed_race,
                null=True,
                on_delete=django.db.models.deletion.CASCADE,
                to="main.race",
            ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "admins",
                    models.ManyToManyField(
                        related_name="organization_admins", to=settings.AUTH_USER_MODEL
                    ),
                ),
                (
                    "main_contact",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "admins",
                    models.ManyToManyField(
                        related_name="instance_admins", to=settings.AUTH_USER_MODEL
                    ),
                ),
                (
                    "main_contact",
                ...
                (
                    "organization",
                    models.ForeignKey(
                        default=main.models.get_test_org,
                        on_delete=django.db.models.deletion.CASCADE,
        ...
        migrations.AddField(
            ...
            name="instance",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="main.instance"
            ),
        ),
        migrations.AddField(
            model_name="campaign",
            name="inventory",
            field=models.ForeignKey(
                default=main.models.get_new_inventory,
                on_delete=django.db.models.deletion.CASCADE,
                to="main.inventory",
            ),
        ),
