        ...
        if request.method == "POST":
            ...
            if form.is_valid():
                ...
                if (
                    ...
                    and "Must be 4 or 9 digits"
                    not in form.errors["social_security_number"][0]
                ):
                    ssn_error = True
    ...
    if request.user.is_authenticated:
        ...
        if request.method == "POST":
            ...
            if form.is_valid() and vitals_form.is_valid():
                ...
                encounter.campaign = Campaign.objects.get(
                ...
                if "submit_encounter" in request.POST:
                    return render(
                        ...
                        {"patient_id": id, "encounter_id": encounter.id},
                    )
            ...
            try:
                encounter = PatientEncounter.objects.filter(patient=p).order_by(
                    "timestamp"
                )[0]
                if units == "i":
                    form.initial = {
                    ...
                    form.initial = {
                        ...
                        "body_height_secondary": round(
                            encounter.body_height_secondary, 2
                        ),
