...
class PatientDiagnosisForm(ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            "diagnosis": autocomplete.ModelSelect2Multiple(
                url="main:diagnosis-autocomplete"
            ),
        }
...
class TreatmentForm(ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            Div(
                Div("diagnosis", css_class="col-md-2"),
                Div("medication", css_class="col-md-5"),
                Div("administration_schedule", css_class="col-md-3"),
...
class PatientForm(ModelForm):
    ...
    def clean_zip_code(self):
        ...
        if (
            len(self.cleaned_data["zip_code"].replace("-", "").replace("_", "")) != 5
            and len(self.cleaned_data["zip_code"].replace("-", "").replace("_", ""))
            != 9
        ):
...
class PatientEncounterForm(ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "diagnoses": autocomplete.ModelSelect2Multiple(
                url="main:diagnosis-autocomplete"
            ),
            ...
            "community_health_worker_notes": Textarea(attrs={"wrap": "off", "rows": 4, "cols": 40}),
        }
...
class HistoryPatientEncounterForm(ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "current_medications": Textarea(attrs={"wrap": "off", "rows": 4, "cols": 80}),
...
class CampaignForm(ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "ethnicity": autocomplete.ModelSelect2Multiple(
                url="main:ethnicity-autocomplete"
            ),
        }
